  ...
  return (
    <div className="flex justify-center items-center my-20">
      <ul className="grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 w-full max-w-screen-lg">
        {data.map((elem, id) => (
          <li className="flex flex-col items-center bg-white p-6 rounded-2xl shadow-md" key={id}>
    ...
    <div className="flex flex-col items-center my-16 w-full">
      ...
      <div className="flex flex-wrap justify-center">
        {data.map((elem, id) => (
          <div
            key={id}
            className="relative w-[340px] h-[340px] mx-2 mb-6 rounded-3xl overflow-hidden hover:text-white"
          >
